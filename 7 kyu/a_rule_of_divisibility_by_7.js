...
// Parameter: number
// Return: array
// Example: 1021 => 102 - 2 = 100 => 10, 2

// Answer
function seven(m) {
  let count = 0;
  // check whether m has at most 2 digits, if not we perform some operations
  while (m > 99) {
    count++;
    // we calculate m with formula m  of the form 10x + y, new m = x - 2y
