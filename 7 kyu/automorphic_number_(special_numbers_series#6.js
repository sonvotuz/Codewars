...
// Parameter: number
// Return: string
// Example: 76 ==> "Automorphic"

// Answer
function automorphic(n) {
  // calculate the square of n and turn it into string
  const square = Math.pow(n, 2).toString();
  // compare the ends of the string with the given number and return result
  return square.slice(square.toString().length - n.toString().length) ===
    n.toString()
    ? "Automorphic"
    : "Not!!";
